...
class MultiCollectMockup(AbstractMultiCollect, HardwareObject):
    """
    This class is almost identical to the MultiCollectMockup class,
    with the difference that we use mono_beam_shutter and white_beam_shutter
    instead of safety_shutter
    """
    ...
    def __init__(self, name):
        ...
        self.bl_control = BeamlineControl(*[None] * 15)
    ...
    def init(self):
        self.setControlObjects(
            ...
            mono_beam_shutter=HWR.beamline.mono_beam_shutter,
            white_beam_shutter=HWR.beamline.white_beam_shutter,
