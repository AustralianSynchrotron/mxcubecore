...
def get_one_shot_schema(resolution_limits: tuple[float, float]) -> dict:
    properties = {
        "exposure_time": {
            ...
            "exclusiveMinimum": 0,
            "default": float(
                get_dialog_box_param("exposure_time", collection_type="one_shot")
            ),
            "widget": "textarea",
        },
        "omega_range": {
            ...
            "exclusiveMinimum": 0,
            "default": float(
                get_dialog_box_param("omega_range", collection_type="one_shot")
            ),
            "widget": "textarea",
        },
        "resolution": {
            ...
            "default": float(
                get_dialog_box_param("resolution", collection_type="one_shot")
            ),
            "widget": "textarea",
        },
        "transmission": {
            ...
            "maximum": 100,
            "default": float(
                get_dialog_box_param("transmission", collection_type="one_shot")
            ),
            "widget": "textarea",
        },
    }
